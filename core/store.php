...
switch($_DATABASE['scheme']) {
  case 'mysql': require __DIR__ . "/store/adapters/mysql.php"; break;
  case 'postgres': require __DIR__ . "/store/adapters/postgres.php"; break;
  case 'sqlite': require __DIR__ . "/store/adapters/sqlite.php"; break;
}
